...
class AmazonReviewPageCalculatorProcessorTest {
    ...
    public void setUp() throws Exception {
        ...
        inputStream = this.getClass().getResourceAsStream("../crawler/example.response.amazon.review.html")
        inputStreamNoMax = this.getClass().getResourceAsStream("../crawler/example.response.amazon.review.noMaxPage.html")
    }
